...
public class UserView extends JDialog {
    ...
    public UserView(MemberDTO loginMember) {
        ...
        setTitle("PC방 사용자 - 좌석 선택"); // 제목 설정
        setSize(1200, 800); // 크기 설정 (이미지에 맞춰 조정)
        setLocationRelativeTo(null); // 화면 중앙에 위치
        setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE); // X 버튼 클릭 시 다이얼로그만 닫히도록
    ...
    private void refreshSeats() {//패널과디비 동기화
        seatPanel.removeAll();
